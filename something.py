...
def main ():
    ...
    # print(board.countNewStates(board.cars, board.board))
...
class Table(object):
    ...
    def getNewHValue(self, car, tile1, tile2):
        child_board = Table(self.cars, self.goal_state)
    ...
    def findAllNewStates(self):
        ...
        for car in self.cars:
            if(car.lie == 'h'):
                ...
                #     while(counter > 0):
                #         # print('i:', i)
                #         if(self.board[car.y][car.x - 1] == 0):
                #             print("before")
                #             self.printBoard()
                #             self.getNewHValue(car, [car.x, car.y],[car.x - 1, car.y])
                #             print("after")
                #             self.printBoard()
                #             print("")
                #             counter -= 1
                ...
                #     print("top of range", board_size - (car.x + car.len) + 1)
                #     for i in range(1, board_size - (car.x + car.len) + 1):
                #         print("i: ", i)
                #         # print("current index: ", car.x + car.len - 1 + i)
            ...
            #             print("before")
            #             self.printBoard()
            #             self.getNewHValue(car, [car.x, car.y],[car.y - i][car.x])
            #             print("after")
            #             self.printBoard()
            #             counter -= 1
            #         else:
    ...
    # def countNewStates(self, cars, board):
    #     num_states = 0
